package com.cao.repairshop.execution.infra.controller.interfaces
...
interface ExecutionApi {
    ...
    fun create(serviceOrderId: UUID, @Valid request: CreateExecutionRequest): ExecutionResponse
    ...
    fun createBatch(serviceOrderId: UUID, @Valid request: CreateExecutionBatchRequest): List<ExecutionResponse>
    ...
    fun update(serviceOrderId: UUID, executionId: UUID, @Valid request: UpdateExecutionRequest): ExecutionResponse
    ...
    fun advanceStatus(serviceOrderId: UUID, executionId: UUID, @Valid request: ExecutionStatusUpdateRequest): ExecutionResponse
}
